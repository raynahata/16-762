...
"""autogenerated by genpy from stretch_demos/VisualServoActionResult.msg. Do not edit."""
import codecs
import sys
...
class VisualServoActionResult(genpy.Message):
  _md5sum = "e5f62eb2cecdccdb33834c1bf0d40a1c"
  _type = "stretch_demos/VisualServoActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','stretch_demos/VisualServoResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(VisualServoActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = stretch_demos.msg.VisualServoResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = stretch_demos.msg.VisualServoResult()
