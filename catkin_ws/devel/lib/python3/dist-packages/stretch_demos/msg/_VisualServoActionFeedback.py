...
"""autogenerated by genpy from stretch_demos/VisualServoActionFeedback.msg. Do not edit."""
import codecs
import sys
...
class VisualServoActionFeedback(genpy.Message):
  _md5sum = "8204b592f233d168714f418486d03f48"
  _type = "stretch_demos/VisualServoActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','stretch_demos/VisualServoFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(VisualServoActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = stretch_demos.msg.VisualServoFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = stretch_demos.msg.VisualServoFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_2d().pack(_x.feedback.angle_error, _x.feedback.distance_error))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.feedback.angle_error, _x.feedback.distance_error,) = _get_struct_2d().unpack(str[start:end])
      return self
