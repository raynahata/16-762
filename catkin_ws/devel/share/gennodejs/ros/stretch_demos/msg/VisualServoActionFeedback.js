...
let VisualServoFeedback = require('./VisualServoFeedback.js');
let actionlib_msgs = _finder('actionlib_msgs');
let std_msgs = _finder('std_msgs');

//-----------------------------------------------------------

class VisualServoActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new VisualServoFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = VisualServoFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new VisualServoActionFeedback(null);
    ...
    data.feedback = VisualServoFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new VisualServoActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = VisualServoFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new VisualServoFeedback()
    }
...
module.exports = VisualServoActionFeedback;
