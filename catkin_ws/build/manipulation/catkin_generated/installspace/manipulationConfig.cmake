...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'manipulation' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '\${prefix}/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT manipulation_NUM_DUMMY_TARGETS)
      set(manipulation_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::manipulation::wrapped-linker-option${manipulation_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR manipulation_NUM_DUMMY_TARGETS "${manipulation_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::manipulation::wrapped-linker-option${manipulation_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND manipulation_LIBRARIES "${interface_target_name}")
...
<<<<<<< Updated upstream:catkin_ws/build/manipulation/catkin_generated/installspace/manipulationConfig.cmake
...
>>>>>>> Stashed changes:catkin_ws/build/respeaker_ros/catkin_generated/installspace/respeaker_rosConfig.cmake
...
set(manipulation_EXPORTED_TARGETS "manipulation_generate_messages_cpp;manipulation_generate_messages_eus;manipulation_generate_messages_lisp;manipulation_generate_messages_nodejs;manipulation_generate_messages_py")
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(manipulation_EXPORTED_TARGETS ${${manipulation_dep}_EXPORTED_TARGETS})
endforeach()
